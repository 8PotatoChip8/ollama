...
var (
	...
	// CloudVisionFallback is the model used to serve image inputs when the
	// requested cloud model does not support images. See OLLAMA_CLOUD_VISION_FALLBACK.
	CloudVisionFallback = String("OLLAMA_CLOUD_VISION_FALLBACK")
...
func AsMap() map[string]EnvVar {
	ret := map[string]EnvVar{
		...
		"OLLAMA_CLOUD_VISION_FALLBACK": {"OLLAMA_CLOUD_VISION_FALLBACK", CloudVisionFallback(), "Cloud model used as a fallback for image inputs when the requested model does not support images (e.g. minimax-m3:cloud)"},
